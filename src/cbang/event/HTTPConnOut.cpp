...
void HTTPConnOut::readHeader(const SmartPointer<Request> &req) {
...
void HTTPConnOut::readBody(const SmartPointer<Request> &req) {
  LOG_DEBUG(4, CBANG_FUNC << "()");
...
void HTTPConnOut::process(const SmartPointer<Request> &req) {
