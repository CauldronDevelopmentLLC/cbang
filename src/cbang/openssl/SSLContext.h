...
namespace cb {
  ...
  public:
    ...
    enum option_t {
      SSL_OP_NO_EXTENDED_MASTER_SECRET                = 1ULL << 0,
      SSL_OP_CLEANSE_PLAINTEXT                        = 1ULL << 1,
      SSL_OP_LEGACY_SERVER_CONNECT                    = 1ULL << 2,
      SSL_OP_ENABLE_KTLS                              = 1ULL << 3,
      SSL_OP_TLSEXT_PADDING                           = 1ULL << 4,
      SSL_OP_SAFARI_ECDHE_ECDSA_BUG                   = 1ULL << 6,
      SSL_OP_IGNORE_UNEXPECTED_EOF                    = 1ULL << 7,
      SSL_OP_ALLOW_CLIENT_RENEGOTIATION               = 1ULL << 8,
      SSL_OP_DISABLE_TLSEXT_CA_NAMES                  = 1ULL << 9,
      SSL_OP_ALLOW_NO_DHE_KEX                         = 1ULL << 10,
      SSL_OP_DONT_INSERT_EMPTY_FRAGMENTS              = 1ULL << 11,
      SSL_OP_NO_QUERY_MTU                             = 1ULL << 12,
      SSL_OP_COOKIE_EXCHANGE                          = 1ULL << 13,
      SSL_OP_NO_TICKET                                = 1ULL << 14,
      SSL_OP_CISCO_ANYCONNECT                         = 1ULL << 15,
      SSL_OP_NO_SESSION_RESUMPTION_ON_RENEGOTIATION   = 1ULL << 16,
      SSL_OP_NO_COMPRESSION                           = 1ULL << 17,
      SSL_OP_ALLOW_UNSAFE_LEGACY_RENEGOTIATION        = 1ULL << 18,
      SSL_OP_NO_ENCRYPT_THEN_MAC                      = 1ULL << 19,
      SSL_OP_ENABLE_MIDDLEBOX_COMPAT                  = 1ULL << 20,
      SSL_OP_PRIORITIZE_CHACHA                        = 1ULL << 21,
      SSL_OP_CIPHER_SERVER_PREFERENCE                 = 1ULL << 22,
      SSL_OP_TLS_ROLLBACK_BUG                         = 1ULL << 23,
      SSL_OP_NO_ANTI_REPLAY                           = 1ULL << 24,
      SSL_OP_NO_SSLv3                                 = 1ULL << 25,
      SSL_OP_NO_TLSv1                                 = 1ULL << 26,
      SSL_OP_NO_TLSv1_2                               = 1ULL << 27,
      SSL_OP_NO_TLSv1_1                               = 1ULL << 28,
      SSL_OP_NO_TLSv1_3                               = 1ULL << 29,
      SSL_OP_NO_DTLSv1                                = 1ULL << 26,
      SSL_OP_NO_DTLSv1_2                              = 1ULL << 27,
      SSL_OP_NO_RENEGOTIATION                         = 1ULL << 30,
      SSL_OP_CRYPTOPRO_TLSEXT_BUG                     = 1ULL << 31,
      SSL_OP_NO_TX_CERTIFICATE_COMPRESSION            = 1ULL << 32,
      SSL_OP_NO_RX_CERTIFICATE_COMPRESSION            = 1ULL << 33,
      SSL_OP_ENABLE_KTLS_TX_ZEROCOPY_SENDFILE         = 1ULL << 34,
      SSL_OP_PREFER_NO_DHE_KEX                        = 1ULL << 35,
    };
