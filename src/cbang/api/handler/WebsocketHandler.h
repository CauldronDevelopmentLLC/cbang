...
namespace cb {
  namespace API {
    ...
    class WebsocketHandler : public HTTP::RequestHandler {
      API &api;
      std::map<uint64_t, WebsocketPtr> websockets;
      std::vector<SmartPointer<WSMessageHandler>> handlers;
    ...
    public:
      ...
      SmartPointer<WSMessageHandler> createHandler(const JSON::ValuePtr &config);
