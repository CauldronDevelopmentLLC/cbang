...
void Adapter::pushHandler(Handler *handler) {handlers.push_back(handler);}


void Adapter::popHandler() {
...
void Adapter::read(const string &filename) {
...
Adapter *Adapter::create() {return new ExpatAdapter();}
